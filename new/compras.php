              ...
              <div class="card mb-3">
                <div class="card-header">
                  <!-- <form method="POST" id="form">
                  	<input type="month" name="dia" id="dia" style="float: right;">
                  	<input type="submit" />
                  </form> -->
                </div>
                <div class="card-body">
                ...
                <div class="card-footer small text-muted"></div>
                  ...
                  <div class="table-responsive">
                    <div class="col-sm-12">
                        <a href="./db/createc.php" class="btn btn-info add-new" style="float: right; background: linear-gradient(60deg, #f00, #7b019b)"><i class="fa fa-plus"></i> Agregar registro/s</a>
                    </div>
                    <table class="table">
                      ...
                      <?php 
                      include ('./db/databasec.php');
                      $compras = new Database();
                      $listado=$compras->read();
                      ?>
                      <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                            <a href="./db/updatec.php?id=<?php echo $id;?>" class="edit" title="Editar" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="./db/deletec.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>  
                  <?php
                    }
