    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Agregar registro a <b>Compras</b></h2></div>
                    <div class="col-sm-4">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $compras->create($fech, $prov, $mont);
					if($res){
			...
			<div class="row">
				...
				<div class="col-md-12">
					<label>Monto:</label>
					<textarea  name="mont" id="mont" class='form-control' maxlength="255" required></textarea>
				</div>
