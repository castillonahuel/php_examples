              ...
              <div class="card mb-3">
                ...
                <div class="card-footer small text-muted"></div>
                  ...
                  <div class="table-responsive">
                    <div class="col-sm-12">
                        <a href="./db/createg.php" class="btn btn-info add-new" style="float: right; background: linear-gradient(60deg, #f00, #7b019b)"><i class="fa fa-plus"></i> Agregar registro/s</a>
                    </div>
                    <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./db/updateg.php?id=<?php echo $id;?>" class="edit" title="Editar" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="./db/deleteg.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>  
                  <?php
                    }
