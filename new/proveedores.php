                ...
                <div class="card-footer small text-muted"></div>
                  ...
                  <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td><?php echo $pag;?></td>
                        <td><?php echo $da;?></td>
                        <td class="text-primary"><?php echo $tot;?></td>
                        <td>
                            <a href="db/updatep.php?id=<?php echo $id;?>" class="edit" title="Editar" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="db/deletep.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr> 
                  <?php
                    }
